import { gameViewNavigationData, settingsViewNavigationData, aboutViewNavigationData } from '../views/viewKeys.js';

// Types
import type { INavigationElement } from './navigationTypes.js';

export const navigationElements: Array<INavigationElement> = [
  gameViewNavigationData,
...
export const getImportableView = async (dynamicFilePath: string) => {
  ...
  if (dynamicFilePath === 'views/GameView') {
    page = await import('./../views/GameView.tsx');
  }
